...
from Sangtei import dispatcher, DEV_USERS, VERSION
...
import Sangtei.modules.helper_funcs.git_api as git
...
def speedtestxyz_callback(update: Update, context: CallbackContext):
    ...
    if query.from_user.id in DEV_USERS:
        ...
        query.answer("You are required to join Mizo Bot Developer's to use this command.")
...
def status(update: Update, context: CallbackContext):
	...
	stat = "--- System Status ---\n"
	stat += f"Miss Sangtei Version: `{VERSION}`""\n"
